...
namespace BillingSystem.DataAxisLayer
{
    class userDAL
    {
        ...
        public bool insert(UserBL u)
        {
            ...
            try
            {
                string ins = "INSERT INTO UserTable(first_name, last_name, email, username, password, contact, gender, user_type, added_date, added_by) VALUES (@first_name, @last_name, @email, @username, @password, @contact, , @gender, @user_type, @added_date, @added_by)";
